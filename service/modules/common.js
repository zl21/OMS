...
export default {
  ...
  fetchActionsInCustomizePage: params => network.post('/p/cs/oc/oms/v1/queryActions' , params),
  ...
  fuzzyquerybyak: params => network.post(commonUtils.splitServiceID('/p/cs/fuzzyquerybyak'), params),
  ...
  getImportDialogHeader: (url, params, header) => network.post(url, params, header),
