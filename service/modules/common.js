...
export default {
  /* 框架标准公共接口： */
  fuzzyquerybyak: (params, serviceId = { serviceId: 'ad-app' }) =>
    $network.post('/p/cs/fuzzyquerybyak', params, serviceId),
  QueryList: (params, serviceId = { serviceId: 'ad-app' }) =>
    $network.post('/p/cs/QueryList', params, serviceId),
  getTableQuery: (params, serviceId = { serviceId: 'ad-app' }) =>
    $network.post('/p/cs/getTableQuery', params, serviceId),
  ...
  updateVirtualLibrary: (params) =>
    $network.post('/api/cs/oc/oms/v1/updateVirtualLibrary', params),
