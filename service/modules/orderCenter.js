...
export default {
  ...
  auditOrderReserve: params => network.post('/p/cs/oc/oms/v1/auditOrderReserve', params), // 反审核
  ...
  markRefundCancel: params => network.post('  /api/cs/oc/oms/v1/markRefundCancel', params),
  modifygoodscheck: params => network.post('/api/cs/oc/oms/v1/modifygoodscheck', params),
  saveStandards: params => network.post('/api/cs/oc/oms/v1/saveStandards', params),
  updateIsLackstock: params => network.post('/api/cs/oc/oms/v1/updateIsLackstock', params),
  saveAppointSplitOrderInfo: params => network.post('/api/cs/oc/oms/v1/saveAppointSplitOrderInfo', params),
  saveSplitOrderInfo: params => network.post('/api/cs/oc/oms/v1/saveSplitOrderInfo', params),
  getSingleObjectPermission: params => network.post('/api/cs/oc/oms/v1/getSingleObjectPermission', params),
  /**
   * 零售发货单 - 详情
   */
   billCopy: params => network.post('/api/cs/oc/oms/v1/billCopy', params), // 丢单赋值或复制订单赋值
   queryObject: params => network.post(commonUtils.splicingGateWay(centerStr,'/p/cs/oc/oms/v1/queryObject'), params), // 获取订单详情
   ...
   initObject: params => network.post(commonUtils.splicingGateWay(centerStr,'/p/cs/oc/oms/v1/initObject'), params),  // 订单详情明细表头
   updateOrderAddr: params => network.post(commonUtils.splicingGateWay(centerStr,'/p/cs/oc/oms/v1/updateOrderAddr'), params),  // 订单详情 - 修改地址
  ...
  orderDeliveryUrgent: params => network.get('/api/cs/oc/oms/v1/orderDeliveryUrgent', params),
  ...
  matchingDelivery: params => network.post('/api/cs/vip/distribution/v1/matchingDelivery', params),
  generateOutOrder: params => network.post('/api/cs/vip/delivery/v1/generateOutOrder', params), // JIT仓库管理-生成出仓单
  recordInvoicing: params => network.post('/api/cs/oc/oms/v1/recordInvoicing', params), // 订单管理-记录发票
  skuListQuery: params => network.post('/p/cs/skuListQuery', params), // 矩阵录入
  updateBeforeWarehouse: params => network.post('/api/cs/vip/distribution/v1/updateBeforeWarehouse', params), // 修改仓库
  saveOrder: params => network.post('/api/cs/oc/oms/v1/saveOrder', params), // 修改收货地址
  // 订单管理 - 设置icon
  saveQueryListConfig: params => network.post('/api/cs/oc/oms/v1/saveQueryListConfig', params),
  queryListConfig: params => network.post('/api/cs/oc/oms/v1/queryListConfig', params),
  downloadPick: params => network.post('/p/cs/vip/v2/pick/download', params), // JIT拣货单 (创建拣货单)
  // JIT配货单(手工占单)
  distributionOccupy: params => network.post('/api/cs/vip/distribution/v1/distributionOccupy', params),
  vipcomMergeDistribution: params => network.post('/api/cs/vip/distribution/v1/vipcomMergeDistribution', params),
  generatePoOrder: params => network.post('/api/cs/vip/po/v1/generatePoOrder', params), // JIT PO单(下载PO单),
  querySgBOutPickorder: params => network.post('/p/cs/sg/v1/warehouse/sgBOutPickorder/querySgBOutPickorder', params), // JIT PO单(下载PO单), // 出库拣货单查询方法
  saveOutPickOrder: params => network.post('/p/cs/sg/saveOutPickOrder', params), // 保存
  auditOutPickOrder: params => network.post('/p/cs/sg/auditOutPickOrder', params), // 审核

  querySgBInPickorder: params => network.post('/p/cs/sg/v1/warehouse/sgBInPickorder/querySgBInPickorder', params),
  saveInPickOrder: params => network.post('/p/cs/sg/v1/warehouse/sgBInPickorder/saveInPickOrder', params),
  auditInPickOrder: params => network.post('/p/cs/sg/v1/warehouse/sgBInPickorder/auditInPickOrder', params), // 审核

  markSureButton: params => network.post('/api/cs/oc/oms/v1/markSureButton', params), // 手工匹配保存
