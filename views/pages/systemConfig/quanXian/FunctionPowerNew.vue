                    ...
                    <tr>
                      ...
                      >
                        <Checkbox
                          ...
                          @on-change="
                            (currentValue) =>
                              tabthCheckboxChange(currentValue, {
                                index: index,
                                column: item,
                              })
                          "
                ...
                <table>
                  <tbody>
                    <tr
                      ...
                      :key="index"
                      :class="
                        upperTableTbodyHighlightIndex === index
                    ...
                    >
                      ...
                      >
                        <Checkbox
                          ...
                          @on-change="
                            (currentValue) =>
                              rowCheckboxChange(currentValue, {
                                row: item,
                                index: index,
                                column: tem,
                              })
                ...
                <table>
                  <tbody>
                    <tr
                      ...
                      :key="index"
                      :class="
                        bottomTableTbodyHighlightIndex === index
                    ...
                    >
                      <td style="width: 200px">
                        <Checkbox
                          ...
                          @on-change="
                            (currentValue) =>
                              extendFunctionCheckboxChange(currentValue, {
                                row: item,
                                index: index,
                              })
                          "
                        ...
                        <Checkbox
                          ...
                          :value="
                            item.children && item.children.length > 0
                              ? item.children[0].permission === 128
                              : false
                          "
                          @on-change="
                            (currentValue) =>
                              functionCheckboxChange(currentValue, {
                                row: item,
                                index: index,
                              })
                          "
