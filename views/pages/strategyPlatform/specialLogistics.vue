 ...
 * @LastEditTime: 2021-06-03 10:45:29
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: /云雀/src/views/pages/strategyPlatform/specialLogistics.vue
-->
<template>
  <div class="specialLogistics otherClass customized-detail" v-loading="loading">
    ...
    <div class="customized-detail-main">
      <Collapse v-model="panelDefaultValue">
        <Panel name="panel_baseInfo">
          基本信息
          <div slot="content">
            <businessForm :form-config="formConfighead" @keyDown="keyDown" :key="force" />
          </div>
        </Panel>
      </Collapse>
      ...
      <Collapse v-model="panelDefaultValue1">
        <Panel name="panel_baseInfo1">
          满足条件
          <div slot="content">
            <businessForm :form-config="formConfig" @keyDown="keyDown" :key="force" />
            <div class="content-li">
              <Button type="info" class="content-li-btn" @click="fnselect">请选择省市区</Button>
            </div>
            <div class="content-li">
              <Table width="550" border :columns="columnsCity" :data="dataCity"></Table>
            </div>
       ...
       <Collapse v-model="panelDefaultValue2">
        ...
        <Panel name="panel_baseInfo2" >
          ...
          <div slot="content" v-show="labelDefaultValue == 'PROPERTY'">
            ...
            <Table border ref="selection" :columns="columns4" :data="data1" @on-select="data1select"></Table>
            <Page :total="total2" show-sizer class-name="tablestyle" @on-change="tablepage2" @on-page-size-change="tablesize2" />
          </div>
        </Panel>
    ...
    <!-- 弹窗组件 -->
    <Modal v-model="modal2" width="460" mask @on-ok="fnok" @on-cancel="fncancelcity">
    ...
    <Modal v-model="modal3" width="660" mask footer-hide>
      <div class="specialLogistics-model-head">
        <div class="specialLogistics-model-head-left">
          <Input placeholder="SPU编码/SKU编码" style="width: auto" @on-enter="fnkeyup"  @on-click="fnkeyup"
           icon="ios-search" >
          </Input>
          <Input placeholder="SPU名称/SKU名称" style="width: auto" @on-enter="fnkeyup1" @on-click="fnkeyup1"
          icon="ios-search">
          </Input>
        </div>
