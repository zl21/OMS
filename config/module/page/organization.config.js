...
export default {
  // 组织中心-员工档案
  CP_C_EMP: {
    component: () => import('branchComponent/page/OrganizationCenter/cp_c_emp'),
    // component: staffRecord,
  },

  // 组织中心-伙伴组织
  CP_C_OUTORG: {
    component: () => import('branchComponent/page/OrganizationCenter/cp_c_outorg'),
    // component: partnerOrganization,
  },  

  // 组织中心-内部组织
  CP_C_INORG: {
    component: () => import('branchComponent/page/OrganizationCenter/cp_c_inorg'),
    // component: innerOrganization,
  },   

  // 组织中心-供应商档案
  CP_C_SUPPLIER: {
    component: () => import('branchComponent/page/OrganizationCenter/cp_c_supplier'),
    // component: supplierRecord,
  },   
  // 组织中心-供应商-门店档案
  CP_C_RSTORE: {
    component: () => import('branchComponent/page/OrganizationCenter/cp_c_warehouse'),
