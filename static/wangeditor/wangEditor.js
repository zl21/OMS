                ...
                events: [{
                    ...
                    fn: function fn() {
                       ...
                       *
                       ...
                       return true;
                       */
                      var html = '<div style="width: 480px;border: 1px solid #D6D6D6;margin: 10px auto;overflow: hidden;"><video src="'+val+'" autoplay="true" controls="controls" width="100%" style="float: left;"></video></div>';
                      if (val) {
                        // 插入视频
                        _this._insert(html);
                      }
