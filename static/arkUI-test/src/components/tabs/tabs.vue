<template>
    <div :class="classes">
        <div :class="[prefixCls + '-bar']">
            ...
            >
            <!-- scrollable  -- true -->
                <div ref="navWrap" :class="[prefixCls + '-nav-wrap', type==='card' ? prefixCls + '-nav-scrollable'  : '']">
                    <span :class="[prefixCls + '-nav-prev', type==='card' ? '' : prefixCls + '-nav-scroll-disabled']" @click="scrollPrev"><Icon type="ios-arrow-back"></Icon></span>
                    <span :class="[prefixCls + '-nav-next', type==='card' ? '' : prefixCls + '-nav-scroll-disabled']" @click="scrollNext"><Icon type="ios-arrow-forward"></Icon></span>
