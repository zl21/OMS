...
<script>
    ...
    export default {
        ...
        data () {
            return {
                prefix: `${burgeonConfig.prefixCls}split`,
                offset: 0,
                oldOffset: 0,
                isMoving: false
            };
        ...
        methods: {
            ...
            getComputedThresholdValue (type) {
                ...
                if (this.valueIsPx) {
 return typeof this[type] === 'string' ? this[type] : size * this[type]; } else {
 ...
 return Math.max(value1, value2);
            ...
            getAnotherOffset (value) {
                let res = 0;
                if (this.valueIsPx) {
res = `${this.$refs.outerWrapper[this.offsetSize] - parseFloat(value)}px`; } else {
res = 1 - value;
}
                return res;
            },
