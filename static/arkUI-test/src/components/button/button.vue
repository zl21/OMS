<template>
    <a
        ...
        <Icon :class="loadClass" type="ios-loading" v-if="loading"></Icon>
...
<script>
    ...
    const prefixCls = `${burgeonConfig.prefixCls}btn`;
    ...
    export default {
        ...
        props: {
            type: {
                validator (value) {
                    return oneOf(value, ['default', 'primary', 'dashed', 'text', 'info', 'success', 'warning', 'error', 'fcdefault','posdefault']);
                },
                default: 'default'
            },
            shape: {
