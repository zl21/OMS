<template>
    <div :class="classes">
                ...
                <div ref="navWrap" :class="[prefixCls + '-nav-wrap', scrollable ? prefixCls + '-nav-scrollable' : '']">
                    ...
                    <div ref="navScroll" :class="[prefixCls + '-nav-scroll']">
                        <div ref="nav" :class="[prefixCls + '-nav']" class="nav-text"  :style="navStyle">
                            ...
                            <div :class="tabCls(item)" :style="tabStyle" v-for="(item, index) in navList" @click="handleChange(index)">
        ...
        <div :class="contentClasses" v-if="isKeepAlive" :style="{ height: isIE ? '100%' : 'auto' }">
            <keep-alive>
                <component
                    :ref="panelRef"
