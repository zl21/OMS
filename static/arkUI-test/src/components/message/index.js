...
const prefixCls = `${burgeonConfig.prefixCls}message`;
const iconPrefixCls = `${burgeonConfig.prefixCls}icon`;
const prefixKey = `${burgeonConfig.prefixCls}message_key_`;
...
function notice (content = '', duration = defaults.duration, type, onClose = function () {}, closable = false, render = function () {}) {
    ...
    // if loading
    const loadCls = type === 'loading' ? ` ${burgeonConfig.prefixCls}load-loop` : '';
    ...
    instance.notice({
        ...
        content: `
            <div class="${prefixCls}-custom-content ${prefixCls}-${type}">
                <i class="${iconPrefixCls} ${iconPrefixCls} incon ${iconType} ${loadCls}"></i>
                <span>${content}</span>
            </div>
        `,
        render: render,
...
export default {
    ...
    destroy () {
        ...
        instance.destroy(`${burgeonConfig.prefixCls}message`);
    }
};
