<template>
    <div :class="classes" @mouseleave="handleMouseleave">
        ...
        <div :class="[prefixCls + '-text iconfont']" v-if="showText" v-show="currentValue > 0">
...
<script>
    ...
    const prefixCls = `${burgeonConfig.prefixCls}rate`;
    export default {
        name: 'Rate',
 ...
 full = true;
                ...
                return [
                    {
                        [`${prefixCls}-star iconfont`]: !this.showCharacter,
                        [`${prefixCls}-star-chart iconfont`]: this.showCharacter,
                        [`${prefixCls}-star-full iconfont`]: (!isLast && full) || (isLast && !this.isHalf),
                        [`${prefixCls}-star-half iconfont`]: isLast && this.isHalf,
                        [`${prefixCls}-star-zero iconfont`]: !full
                    }
                ];
            },
