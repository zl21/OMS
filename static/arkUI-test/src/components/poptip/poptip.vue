            ...
            <div
                ...
                <div :class="[prefixCls + '-content ']">
                    ...
                    <div :class="[prefixCls + '-inner']" v-if="!confirm">
                        ...
                        <div :class="[prefixCls + '-body ' +popperClass]" :style="contentPaddingStyle">
...
import burgeonConfig from '../../assets/config';
    ...
    const prefixCls = `${burgeonConfig.prefixCls}poptip`;
    ...
    export default {
        ...
        computed: {
            ...
            styles () {
                ...
                if (this.transfer) {
style['z-index'] = Vue.prototype.$IVIEW.defaultZindex  + this.tIndex;
}
