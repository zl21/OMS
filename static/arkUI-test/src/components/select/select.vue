      ...
      <Drop :class="dropdownCls"
        ...
        <ul :class="prefixCls + '-dropdown-list'"
          ...
          <li :class="selectAllCls"
              ...
              @click.stop="selectAll">{{t('i.select.all')}}</li>
          <li :class="selectAllCls"
              v-if="multiple && selectOptions.length > 0 && multipleType"
              @click.stop="selectAll"><span>{{t('i.select.all')}}</span><span @click.stop="selectAll"></span><span @click.stop="clearSelectAll">{{t('i.select.clear')}}</span></li>
