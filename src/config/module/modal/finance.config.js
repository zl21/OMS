...
export default {
  ...
  DOWNLOADVIPBILL: {
    component: () => import(
      /* webpackChunkName: 'FinanceCenterModal' */
      '@/views/modal/financeCenter/downLoadVipBill.vue'
    ),
  },
  ...
  GENERATESALESORDER: {
    component: () => import(
      /* webpackChunkName: 'FinanceCenterModal' */
      '@/views/modal/financeCenter/generateSalesOrder.vue'
    ),
  },
  // 支付宝下载账单
  // DOWNLOADALIPAYBILL: {
  ...
  AUTHORIZE:{
    component: () => import(
      /* webpackChunkName: 'FinanceCenterModal' */
      '@/views/modal/financeCenter/authorize.vue'
    ),
  },
