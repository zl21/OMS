    ...
    return {
        ...
        formData: [
          ...
          },
          {
            ...
            options: [
              ...
              {
                label: vmI18n.t("other.toBeDelivered"), //待发货
      ...
      pulicdownLoadConfig: {
        ...
        formData: [
          ...
          {
            style: "input", //输入框类型
            label: vmI18n.t("form_label.platformCommodityID"), //平台商品ID 输入框前文字
            value: "sp_ids", //输入框的值
      ...
      downLoadDistributionGood: {
        ...
        formData: [
          ...
          {
            style: "input", //输入框类型
            label: vmI18n.t("form_label.goodsPID"), //输入框前文字
            value: "ware_id", //输入框的值
            width: "24", //所占的宽度 (宽度分为24份,数值代表所占份数的宽度)
            icon: "", //输入框后带的图标,暂只有输入框支持
            placeholder: "", //占位文本，默认为请输入
          ...
          {
            style: "input", //输入框类型
            label: vmI18n.t("table_label.productNo"), //商品编码 输入框前文字
