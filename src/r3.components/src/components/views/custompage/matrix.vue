<template>
  ...
  >
    ...
    >
      <span>
        <span v-if="tablename!='SG_B_PHY_ADJUST'"> {{ tablename === 'DL_B_RETAIL'? $t('custompage.shop'): $t('input.store') }}︰{{ store }}</span>
        <label
          v-if="isStoreFlag"
              ...
              <ul v-if="edit || general">
                ...
                >
                  ...
                  >
                    ...
                    <span>{{$t('custompage.enterDigit',{num:7})}}</span>
                  </div>
                </li>
              </ul>
            </td>
          ...
          .then((res) => {
            ...
            if (resData.code === 0) {
              ...
              if (resData.data) {
                ...
                this.$store.commit('customize/errorDialog', {
                  // 其它报错
                  message: {
                    data: errorData
                  }
