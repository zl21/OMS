<template>
  <div class="scanIn">
    ...
    <!-- 失败提示 -->
    <Modal :title="vmI18n.t('modalTitle.tips')" v-model="isModal3">
      <p>{{ errModelTitle }}</p>
    </Modal>
    <!-- 提示音 -->
    <audio id="fm01">
              ...
              self.$network
                ...
                .then((res) => {
                  ...
                  if (res.data.code === 0) {
                    ...
                    self.errModelTitle =
                      res.data.message || self.vmI18n.t("modalTips.i2"); //强制入库失败
                    self.isModal3 = true;
                    self.error_one();
          ...
          // },
          {
            ...
            radioChange: () => {
              ...
              const data = self.formConfig3.formData.find(
                (item) =>
                  item.label === self.vmI18n.t("form_label.receivedBarcode") //实收条码
              );
              if (val == "0") {
                data.style = "";
              } else {
