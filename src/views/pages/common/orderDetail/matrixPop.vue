...
<style lang="less" scoped>
  @import "~@/css/pages/common/orderDetail/matrixPopScope";
</style>
<style>
  @import "~@/css/pages/common/orderDetail/matrixPop";
</style>

<script>
  import matrixPop from '@/js/pages/common/orderDetail/matrixPop';
