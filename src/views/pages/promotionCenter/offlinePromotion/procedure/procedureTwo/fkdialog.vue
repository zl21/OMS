  ...
  >
    ...
    >
      ...
      <div class="dialog_right">
        <div class="right_top">
          <span>{{ ChineseDictionary.HASBEENSELECTED }}</span><span>(</span><span>{{ r_center_data.rightTotal }}条</span><span>)</span>
    ...
    methods: {
      ...
      searchWordChange(a) {
       // let str = '';
        ...
        // }
        this.$refs.searchWord.currentValue = a
        //str[0];
        this.searchWord = a
        //str[0];
      }, // 搜索全局检索限制
