<template>
  ...
  <div class="propdis3">
    ...
    <el-select  v-model=rule.conditionName  v-if="scheme_data.promotionType_code==='PA12' || scheme_data.promotionType_code==='PA11' || scheme_data.promotionType_code==='GA12'"  placeholder="请选择" @change="changeConditionName" style="width: 120px;">
      <el-option
