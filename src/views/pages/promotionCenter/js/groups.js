...
colGroups.prototype.getSelect = function () {
    ...
    axios({
        ...
        if (res.data.code === 0) {
            ...
            window.vm.$store.commit('saveForginKey',{key:'groups',value:this.groups});
        }
    });
}
...
colGroups.prototype.getPromField = function(){
    ...
    axios({
        ...
        if (res.data.code === 0) {
            ...
            window.vm.$store.commit('saveForginKey',{key:'columnIds',value:this.columnIds});
        }
    });
