        ...
        <Table :columns="products_columns" :data="list.products" border>
          <template slot-scope="{ row, index }" slot="ECODE">
            ...
            <TableSku
              :itemdata="itemdata"
              :row="row"
              @getFilterChooseItem="(item,row)=>{getFilterChooseItem(item,row,listIndex,index,'product')}"
        ...
        <Table :columns="gift_columns" :data="list.gift_products" border>
          <template slot-scope="{ row, index }" slot="ECODE">
            ...
            <TableSku
              ...
              :row="row"
              @getFilterChooseItem="(item,row)=>{getFilterChooseItem(item,row,listIndex,index,'gift')}"
