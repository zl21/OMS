  ...
  <div class="giftSet">
    ...
    <div v-if="showPdtsArr" class="row">
      ...
      <div class="form_content">
        <SingleBox :value="giftData.steps_type" :options="groups.stepsType" @changeSingle="checkStepsTypeChange" />
      </div>
    </div>
    <!--赠品翻倍-->
    <div class="row">
    ...
    <!--赠送方式-->
    <div class="row">
      <div class="form_label"><i class="red">*</i>{{ vmI18n.t('form_label.giving_ways') }}：</div>
      <div class="form_content">
    ...
    <div class="row" v-if="showPdtsArr">
      ...
      <div class="form_content">
        <SingleBox :value="giftData.give_num_share" :options="groups.giveNumShare" @changeSingle="checkGiftGrossChange" />
      </div>
    </div>
    <!--梯度-->
    <div v-if="showPdtsArr" class="row">
      ...
      <div class="form_content">
        ...
        >
          <div slot="action" class="form_button">
            <ButtonFkDialog :itemdata="itemdataFk" @getFkChooseItem="getButtonFkChoose" />
