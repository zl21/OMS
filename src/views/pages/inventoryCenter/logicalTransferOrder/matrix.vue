...
<script>
  import matrix from '@/js/pages/inventoryCenter/logicalTransferOrder/matrix';

  export default matrix;
</script>
<style lang="less" scoped>
  @import "~@/css/pages/inventoryCenter/logicalTransferOrder/matrix";
</style>
