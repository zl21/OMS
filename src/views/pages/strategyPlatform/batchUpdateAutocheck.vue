              ...
              <Row :gutter="1">
                ...
                <Col span="6">
                  <FormItem label="零元订单自动审核：">
                    <Select
                      v-model="IS_ZERO_AUTOCHECK"
                      @on-change="setResult('IS_ZERO_AUTOCHECK')"
                      style="width: 100px"
                    >
                      <Option value="Y">是</Option>
                      <Option value="N">否</Option>
          ...
          <Panel name="2">
            ...
            <div slot="content" class="content">
              ...
              <Row>
                ...
                <Col colspan="1" span="1" style="padding-top: 5px"
                  ><span>启用:</span></Col
                >
              ...
              <Row>
                ...
                <Col span="11">
                  <i
                    style="position: absolute; top: 10px; left: 8px; color: red"
                    v-show="effectiveCondition[2].value == 'Y'"
                    >*</i
                  >
...
<style lang="less">
@import "~@/css/modal/strategyPlatform/batchUpdateAutocheck.less";
</style>