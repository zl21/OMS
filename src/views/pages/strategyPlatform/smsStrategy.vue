  ...
  <div class="wphemail">
    <Form :label-width="80">
      ...
      <FormItem label="内容：" class="mailFormItem">
        <div class="item-area">
          <component :is="currentView" :ref="currentView + `${this.objid}`" :storage-item="storageItem" :itemdata="itemdata" :tab-action="!modify" @getChangeItem="getChangeItem" />
        </div>
      </FormItem>
    </Form>
  </div>
...
<script>
  import smsStrategy from '@/js/pages/strategyPlatform/smsStrategy';

  export default smsStrategy;
</script>
<style  lang='less'  scoped>
  @import '~@/css/pages/strategyPlatform/smsStrategy.less';
</style>
