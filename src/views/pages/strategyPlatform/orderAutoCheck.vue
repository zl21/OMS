...
&nbsp;
                    ...
                    <i
                      ...
                      style="position:absolute;top:10px;left:20px;color:red"
                    >*</i>
                    <FormItem label="付款时间：">
                      <Row>
                        <Col span="11">
...
&nbsp;
                    ...
                    <i
                      ...
                      style="position:absolute;top:10px;left:-4px;color:red"
                    >*</i>
...
&nbsp;
                    ...
                    <i
                      ...
                      style="position:absolute;top:10px;left:30px;color:red"
                    >*</i>
                    <FormItem label="收货地址:">
                      <Input
