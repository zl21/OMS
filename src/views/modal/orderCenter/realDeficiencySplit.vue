...
Vue.component('drpInput', $BC.default.Components.Fkinput);
...
export default {
  ...
  data() {
    return {
              ...
              h('drpInput', {
                ...
                on: {
                  getFkChooseItem: (val) => {
                    ...
                    val.pid = val.ADDRESS ? val.ADDRESS.val : undefined;
      ...
      itemdata: {
        ...
        colname: 'NEW_PS_C_SKU_ECODE', // 当前字段的名称
        datelimit: 'all',
  ...
  methods: {
    ...
    getFkChooseItem(val, rowD) {
      rowD.row.NEW_PS_C_SKU_ECODE = val.ADDRESS ? val.ADDRESS.val : '';
      rowD.row.actionName = 'UPDATE';
