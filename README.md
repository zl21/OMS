...
| v1.10.57 | 额外退款单 修改 | 
| v1.10.58 | bug:44138 | 
| v1.10.59 | bug: 44180 ｜ 44196 | 43779| 
| v1.10.60 | 退换货单修改判断条件| 
| v1.10.61 | 1.完成支付宝账单授权和完成自定义预售策略| 
| v1.10.62 | fix:额外退款单-退款失败处理默认值| 
| v1.10.63 | 修复bug42927| 
| v1.10.64 | 促销换网关r3-sg | 
| v1.10.65 | 修改预计发货时间 | 
| v1.10.66 | 修改预计发货时间-默认当前时间 | 
| v1.10.67 | 零售-复制-隐藏收货人信息 | 
| v1.10.68 | bug:44123 | 
| v1.10.69 | bug:44248\44247 | 
| v1.10.70 | bug:44272|
| v1.10.71 | bug:修复金额|
| v1.10.72 | fix:44281,44276 | 
| v1.10.73 | bug:44256|
| v1.10.74 | 修复额外退款单|
| v1.10.75 | 零售发货单详情样式修改|
| v1.10.76 | bug:44294|
| v1.10.77 | bug:44253 |
| v1.10.78 | add listFormButton |
| v1.10.79 | bug: 44320 |
| v1.10.80 | 单对象按钮布局调整 |
| v1.10.81 | fix:44290 |
| v1.10.82 | fix:44290 |
| v1.10.83 | fix:44253 |
| v1.10.84 | fix:卖家备注-正则-仅限制英文的单双引号 |
| v1.10.85 | bug，修复43781 |
| v1.10.86 | bug，修复44304|
| v1.10.87 | bug，修复44331 |44392 |
| v1.10.88 | 淘宝退货单-拒绝换货 |
| v1.10.89 | 退换-提示随按钮名字变更'换货先发' |
| v1.10.90 | bug:44381、44391、44394、44300 |
| v1.10.91 | 替换项目静态资源 |
| v1.10.92 | 修复自定义和hodl单bug ｜退换货单/新增退换货单：替换明细添加重置 ｜ 额外退款单修改|
| v1.10.93 | bug:44430|
| v1.10.94 | 迁移项目minxin文件夹 |
| v1.10.95 | 额外退款单：接口添加参数refundType |
| v1.10.96 | bug:44407 |
| v1.10.97 | 去掉debugger |
| v1.10.98 |  |
| v1.10.99 |  |
| v1.11.1 | 退换货单-修改申请退货数量限制字段 ｜ bug：44271|
| v1.11.2 | 额外退款单 - 删除明细接口移入私仓|
| v1.11.3 | 额外退款单 - 删除添加提示 |
| v1.11.4 | bug:44497|
| v1.11.5 | 退换货单修复问题|
| v1.11.6 | bug:44451|
| v1.11.7 | bug:44533|
| v1.11.9 | bug:44547|
| v1.11.10 | 零售发货单省市区添加title|
| v1.11.11 |  |
| v1.11.12 | 赔付 |
| v1.11.13 | 按钮修改 |
| v1.11.14 | 零售发货单详情添加合计 ｜小眼睛修改 | 定制界面form表单展开箭头 |
| v1.11.15 | 额外退款单添加 - 回车事件 And 单选样式 | 退换货单明细添加参数|
| v1.11.16 | bug :44650|
| v1.11.17 | 退换货单添加栅格栏配置|
| v1.11.18 | 菜单箭头展开收缩|
| v1.11.19 | bug :44679 |
| v1.11.20 | bug :44666，44659 |
| v1.11.21 | 表头居中v1 |
| v1.11.22 | 表头居中v2 |
| v1.11.23 | 表头居中v3 |
| v1.11.25 | 侧边导航收缩bug修复 |
| v1.11.26 | 增加数据权限切换角色和切换权限类型弹出提示框 |
| v1.11.27 | bcl版本更新，表头居中调整 |
| v1.11.28 | 零售发货单详情页面修改 |
| v1.11.29 | 菜单收缩去掉动画效果 |
| v1.11.30 | 零售发货单详情 - 图标修改大小 |
| v1.11.31 | tips调整 |
| v1.11.32 | 零售-列表-表格-序号列修复 |
| v1.11.33 | 零售发货单详情 - 修改弹框节点 |
| v1.11.34 | 赔付-关闭当前tab |
| v1.11.36 | 样式修改 |
| v1.11.37 | 修复bug44768， 44759|
| v1.11.38 | 优化标准界面按钮是否展示|
| v1.11.40 | iconfont大小调整｜促销中心列表 按钮调整 ｜
| v1.11.41 | 赔付-明细数据唯一标识处理 |
| v1.11.42 | 零售发货单详情 - 字段修改 ｜ agtable表头居中处理 |
| v1.11.43 | 修复支付宝账单下载模糊搜索取值问题 |
| v1.11.44 | 增加自定义预售，或 文本和删除按钮,增加审单策略删除按钮,修复hodl单编辑页面显示问题 |
| v1.11.45 | 防暴力点击测试 |
| v1.11.46 | 发货前退款单和已发货退款单修改 |
| v1.11.47 | spu->sku入参数调整 |
| v1.11.48 | spu-商品分类查询入参调整 |
| v1.11.49 | 样式修改---暂时 |
| v1.11.50 | 退换货单明细 修改字段 |
| v1.11.51 | 修复bug44821，44822 |
| v1.11.52 | 特殊接口绕过框架防爆机制的处理 |
| v1.11.53 | spu新增/详情-供应商-取消按钮权限控制 |
| v1.11.54 | 零售-新增-明细计算 |
| v1.11.55 | spu新增/详情-供应商-fkTable展开展示问题-下面距离不够时应向上定位 |
| v1.11.56 | 保留两位小数补零方法修改 |
| v1.11.58 | 样式修改 |
| v1.11.59 | 44815 【测试环境】-【零售发货单】-【添加赠品】：添加赠品后，零售发货单明细未刷新
| v1.11.60 | 零售发货单详情修改
| v1.11.61 | 零售发货单详情-商品总金额语言包修改
| v1.11.62 | bug:44837 |
| v1.11.63 | 零售发货单-所有单选弹框修改
| v1.11.64 | 退换货单编辑-修改
| v1.11.65 | 促销：fkinput单独使用时label展示问题修复 |
| v1.11.66 | spu: 暂存在前端的数据,ID='-1,解决详情时切换明细tab表格的数据会丢失的问题 |
...
| v1.11.75 | form表单定制+标准收缩按钮定位 |
| v1.11.76 | 删除无用文件 |
| v1.11.77 | 箭头修改 |
| v1.11.80 | 删除无用文件 |
| v1.11.81 | 修复零售发货单替换商品弹框 |
| v1.11.82 | 文件整理 |
| v1.11.83 | 登录改造 |
...
| v1.11.92 | 分货单导入 |
| v1.11.93 | 分货单导入 |
| v1.11.94 | 订单中心 - 零售发货单And退换货单详情：小眼睛做节流 |
| v1.11.95 | spu/sku-属性panel不可编辑修复 |
| v1.11.97 | 退换货单详情添加明细修复 |
| v1.11.98 | 登录国际化、分货单导入配置 |
| v1.11.99 | 登录优化 |
| v1.12.1 | spu保存报错修复 |
| v1.12.2 | 储存屏幕宽度及列数移到私仓 |
| v1.12.3 | 去掉tree样式 |
| v1.12.4 | 分货单导入配置 |
...
| v1.12.14 | 图片资源统一更换别名 |
| v1.12.15 | 修改样式 |
| v1.12.16 | businessForm class修改 |
| v1.12.17 | login 修改 |
| v1.12.18 | 修复界面样式若干 |
| v1.12.19 | ag样式调整 |
| v1.12.20 | login调整｜仓库物流设置修改 |
| v1.12.21 | 样式调整、档期日程新增隐藏操作日志 |
| v1.12.23 | 样式调整 |
| v1.12.24 | 私仓版本号挂在全局 |
| v1.12.25 | 数据权限样式修改 |
| v1.12.26 | 档期日程日志配置 |
| v1.12.27 | 零售发货单详情修改 |
| v1.12.28 | 修复档期日程i18n |
| v1.12.29 | 单对象界面 - 明细下拉单选 ｜ 监控平台修改 |
| v1.12.30 | 统一 $Message |
| v1.12.31 | 零售发货单修改 |
| v1.12.33 | 零售发货单修改地址提示位置修改 |
| v1.12.34 | 登录成功前走框架回调切换语言 |
| v1.12.35 | 零售发货单列表样式修改 |
| v1.12.37 | fkinput样式 |
| v1.12.38 | style:login btn |
| v1.12.39 | 监控平台-数据mock |
| v1.12.41 | 版本信息 |
| v1.12.42 | 删除arkui_BCL |
| v1.12.44 | 添加更换主题组件 |
| v1.12.45 | 移除wangEditor |
| v1.12.47 | 隐藏主题切换 |
| v1.12.48 | 删除多余的custom-ag-grid-table.js |
| v1.12.50 | 优化.vue后缀引用 && 修改部分引用别名 '@/views/pages'-> 'allpages'|
| v1.12.51 | 隐藏框架登录页的切换语言控件 |
| v1.12.52 | 依赖包版本信息 |
| v1.12.53 | remove ag |
| v1.12.54 | 零售发货单-折叠开关动态定位 |
| v1.12.55 | 登录-兼容框架升级 |
| v1.12.56 | 登录优化 |
| v2.0.0 | 重构后第一版-R3调整为cdn引入 |
